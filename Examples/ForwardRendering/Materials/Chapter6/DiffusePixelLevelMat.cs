...
public class DiffusePixelLevelMat(TrContext context) : TrMaterial<TrSceneParameters>(context, "DiffusePixelLevel")
{
    #region Uniforms
    ...
    {
        using TrShader vert = new(Context, TrShaderType.Vertex, "Resources/Shaders/Chapter6/DiffusePixelLevel.vert.spv".PathFormatter());
        using TrShader frag = new(Context, TrShaderType.Fragment, "Resources/Shaders/Chapter6/DiffusePixelLevel.frag.spv".PathFormatter());
