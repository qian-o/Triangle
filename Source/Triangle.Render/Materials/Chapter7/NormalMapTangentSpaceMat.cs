...
public class NormalMapTangentSpaceMat(TrContext context) : GlobalMat(context, "NormalMapTangentSpace")
{
    ...
    protected override TrRenderPass CreateRenderPass()
    {
        ...
        using TrShader vert = new(Context, TrShaderType.Vertex, "Resources/Shaders/Chapter7/NormalMapTangentSpace/NormalMapTangentSpace.vert.spv".Path());
        using TrShader frag = new(Context, TrShaderType.Fragment, "Resources/Shaders/Chapter7/NormalMapTangentSpace/NormalMapTangentSpace.frag.spv".Path());
